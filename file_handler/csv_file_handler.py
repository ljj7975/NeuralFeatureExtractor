...
class CsvFileHandler(FileHandler):
    ...
    def _prepare_file(self, dir_path):
        self.feature_file_writer = csv.writer(open(os.path.join(dir_path, "feature.csv"), mode='w'))
        self.label_file_writer = csv.writer(open(os.path.join(dir_path, "label.csv"), mode='w'))
